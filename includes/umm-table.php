...
class UMM_UI extends UMM_List_Table {
    ...
    function display_module(){
        ...
        <div class="umm-wrapper" data-sub_action="<?php echo (isset($_REQUEST['umm_sub_action']) ? $_REQUEST['umm_sub_action'] : ''); ?>" data-help_text="<?php _e('User Meta Manager Help &amp; Settings', UMM_SLUG) ?>" data-umm_loading_image="<?php echo WP_PLUGIN_URL . "/user-meta-manager/images/umm-loading.gif" ?>" data-first_run="<?php echo $first_run ?>" data-no_spaces="<?php _e('No Spaces', UMM_SLUG) ?>" data-invalid_chars_warning="<?php _e('Letters, numbers, and underscores only.', UMM_SLUG) ?>" data-key_exists="<?php _e('<strong>Error:</strong> That key already exists. Choose a different name.', UMM_SLUG) ?>" data-duplicate_override="<?php echo (isset($settings['duplicate_check_override']) ? $settings['duplicate_check_override'] : '');  ?>">
                ...
                <div class="umm-subpage-wrapper">
                    ...
                    <div id="umm-home">
                        ...
                        <form id="umm-form" method="GET">
                            <input class="umm-mode" type="hidden" name="umm_mode" value="<?php echo (isset($_REQUEST['umm_mode']) ? $_REQUEST['umm_mode']:'') ?>" />
